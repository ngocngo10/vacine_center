...
/* GET users listing. */
router.post('/', authMiddleware.validateToken, authMiddleware.isStaff, InjectionController.create);
router.get('/', InjectionController.find);
router.get('/:id', InjectionController.findOne);
router.put('/:id', authMiddleware.validateToken, authMiddleware.isStaff, InjectionController.update);
