...
const AdminUpdateCategory = () => {
  ...
  const onFinish = (values) => {
    values.id = id;
    values.image = imageUrl ? imageUrl : category ? category.image : '';
  ...
  return (
    <Card title=" Cập nhật loại bệnh mà vắc xin phòng" loading={false} className="category-card">
      <Row justify="space-around">
        <Col span={3}>
          <Image
            src={imageUrl ? imageUrl : category ? category.image : ''}
          ...
          <input
            type="file"
            class="custom-file-input custom-file-input--category"
            name="image-file"
          ...
          <Form
            ...
            <Row justify="center">
              <Button
                ...
                onClick={() => {
                  navigate('/admin-home/disease-categories');
                }}>
                Hủy
              </Button>
              <Button
